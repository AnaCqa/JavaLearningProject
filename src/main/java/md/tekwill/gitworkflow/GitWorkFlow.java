...
public class GitWorkFlow {
    ...
    public static void main(String[] args) {
        ...
        String step4 = "Perform git checkput -b new_branch_name command - to create and instantly move to a new branch" +
        ...
        String step12 = "If you collect at least 1 approvals from your colleagues then merge the branch";
