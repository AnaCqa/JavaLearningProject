package md.tekwill.variableandcomments;
...
public class VariablesAndComments {
    ...
    public static void main(String[] args) {
        ...
        boolean trueBooleanOfVariable;
        boolean falseBooleanOfVariable;
        ...
        // Intialization of the above variables

        trueBooleanOfVariable = true;
        falseBooleanOfVariable = false;
        ...
        upperLimitOfDoubleDataType = 1.7E+305d;
        firstCharFromAscii = 'A';
        lastCharFromAscii = '#';

        System.out.println(trueBooleanOfVariable);
        System.out.println(falseBooleanOfVariable);
